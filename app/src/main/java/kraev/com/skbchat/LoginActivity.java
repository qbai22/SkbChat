...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this;
        //если пользователь залогинен то направляем его сразу в чат
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    if (password.length() < 6) {
                                        mPasswordEditText.setError(getString(R.string.password_too_short_toast));
                                    } else {
                                        if(!NetworkUtils.isNetworkAvailableAndConnected(mContext)){
                                            Toast.makeText(LoginActivity.this, R.string.network_unavailible_toast, Toast.LENGTH_SHORT)
                                                    .show();
                                        } else {
